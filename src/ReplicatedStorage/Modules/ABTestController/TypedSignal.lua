...
function tbl_4_upvr.Connect(arg1, arg2) -- Line 212
	--[[ Upvalues[1]:
...
function tbl_4_upvr.ConnectOnce(arg1, arg2) -- Line 235
	return arg1:Once(arg2)
end
function tbl_4_upvr.Once(arg1, arg2) -- Line 254
	local var14_upvw = false
	local var15_upvw
	var15_upvw = arg1:Connect(function(...) -- Line 258
		--[[ Upvalues[3]:
...
function tbl_4_upvr.GetConnections(arg1) -- Line 271
	local module = {}
...
function tbl_4_upvr.DisconnectAll(arg1) -- Line 291
...
function tbl_4_upvr.Fire(arg1, ...) -- Line 326
	--[[ Upvalues[2]:
		[1]: var1_upvw (read and write)
...
function tbl_4_upvr.FireDeferred(arg1, ...) -- Line 347
...
function tbl_4_upvr.Wait(arg1) -- Line 375
...
function tbl_4_upvr.Destroy(arg1) -- Line 405
	arg1:DisconnectAll()
...
setmetatable(tbl_4_upvr, {
	__index = function(arg1, arg2) -- Line 416, Named "__index"
		error("Attempt to get Signal::%s (not a valid member)":format(tostring(arg2)), 2)
	end;
	__newindex = function(arg1, arg2, arg3) -- Line 419, Named "__newindex"
