...
function module_upvr.SetTarget(arg1, arg2) -- Line 31
	...
	var6_upvw = UserInputService_upvr:GetMouseLocation().Y
...
local function UpdatePosition_upvr() -- Line 46, Named "UpdatePosition"
	...
	if not module_upvr.Target then
		...
		var13.CurrentOffset += Y - var6_upvw
		var6_upvw = Y
		local var14 = module_upvr.StartPivot * CFrame.Angles(math.rad(RoundToNearestNumber_upvr(module_upvr.CurrentOffset, ROTATION_CONFIG_upvr.ROTATION_ROUNDING_PIXEL) / ROTATION_CONFIG_upvr.ROTATION_ROUNDING_PIXEL * ROTATION_CONFIG_upvr.ROTATION_STEP_DEGREE), 0, 0)
