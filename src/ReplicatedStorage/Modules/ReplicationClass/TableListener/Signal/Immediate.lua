...
function module_upvr.Wait(arg1) -- Line 226
	local var15_upvw
	local current_thread_upvw = coroutine.running()
	var15_upvw = arg1:Connect(function(...) -- Line 231
		--[[ Upvalues[2]:
...
function module_upvr.Fire(arg1, ...) -- Line 256
	--[[ Upvalues[2]:
		[1]: var3_upvw (read and write)
...
function module_upvr.DisconnectAll(arg1) -- Line 287
...
function module_upvr.Destroy(arg1) -- Line 316
	if arg1._active ~= true then
	else
		arg1:DisconnectAll()
		arg1._active = false
...
function tbl_upvr.Disconnect(arg1) -- Line 339
