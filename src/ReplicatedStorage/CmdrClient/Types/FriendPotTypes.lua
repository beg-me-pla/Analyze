...
local module_upvr = {}
for _, v in game:GetService("ReplicatedStorage").Assets.Models.FriendshipPots:GetChildren() do
...
local tbl_upvr = {
	...
	Validate = function(arg1) -- Line 20, Named "Validate"
		...
		return var11, "No seeds could be found."
	end;
...
return function(arg1) -- Line 44
	...
	arg1:RegisterType("friendshippottype", tbl_upvr)
end